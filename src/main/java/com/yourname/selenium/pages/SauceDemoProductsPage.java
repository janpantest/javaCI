...
import com.yourname.selenium.fixtures.DateUtils;
...
public class SauceDemoProductsPage {
    ...
    public SauceDemoProductsPage(WebDriver driver) {
        ...
        date = DateUtils.getCurrentFormattedDateTime();
    }
    ...
    public void getAllProductsName() {
        ...
        // try (BufferedWriter writer = new BufferedWriter(new FileWriter("outputProducts.txt", true))) {
        //     for (WebElement productName : product) {
        //         writer.write(productName.getText());
        //         writer.newLine();
        //     }
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("outputProductsName.txt", false))) {
            for (WebElement productName : product) {
                writer.write(date + " : " + productName.getText());
                writer.newLine();
            }
        }
        catch (IOException e) {
